...
class SettingsTbl extends Table with TableInfo<SettingsTbl, SettingsTblData> {
  ...
  static const VerificationMeta _jsonDataMeta = const VerificationMeta('jsonData');
  ...
  static const VerificationMeta _metaCreatedAtMeta = const VerificationMeta('metaCreatedAt');
  ...
  static const VerificationMeta _metaUpdatedAtMeta = const VerificationMeta('metaUpdatedAt');
...
class KvTbl extends Table with TableInfo<KvTbl, KvTblData> {
  ...
  static const VerificationMeta _vstringMeta = const VerificationMeta('vstring');
  ...
  static const VerificationMeta _vdoubleMeta = const VerificationMeta('vdouble');
...
class $SettingsTblFilterComposer extends Composer<_$Database, SettingsTbl> {
  ...
  ColumnFilters<String> get jsonData =>
      $composableBuilder(column: $table.jsonData, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get memo => $composableBuilder(column: $table.memo, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get metaCreatedAt =>
      $composableBuilder(column: $table.metaCreatedAt, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get metaUpdatedAt =>
      $composableBuilder(column: $table.metaUpdatedAt, builder: (column) => ColumnFilters(column));
}
...
class $SettingsTblOrderingComposer extends Composer<_$Database, SettingsTbl> {
  ...
  ColumnOrderings<String> get jsonData =>
      $composableBuilder(column: $table.jsonData, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get memo =>
      $composableBuilder(column: $table.memo, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get metaCreatedAt =>
      $composableBuilder(column: $table.metaCreatedAt, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get metaUpdatedAt =>
      $composableBuilder(column: $table.metaUpdatedAt, builder: (column) => ColumnOrderings(column));
}
...
class $SettingsTblAnnotationComposer extends Composer<_$Database, SettingsTbl> {
  ...
  GeneratedColumn<String> get jsonData => $composableBuilder(column: $table.jsonData, builder: (column) => column);

  GeneratedColumn<String> get memo => $composableBuilder(column: $table.memo, builder: (column) => column);

  GeneratedColumn<int> get metaCreatedAt =>
      $composableBuilder(column: $table.metaCreatedAt, builder: (column) => column);

  GeneratedColumn<int> get metaUpdatedAt =>
      $composableBuilder(column: $table.metaUpdatedAt, builder: (column) => column);
}

class $SettingsTblTableManager
    extends
        RootTableManager<
          _$Database,
          SettingsTbl,
  ...
  $SettingsTblTableManager(_$Database db, SettingsTbl table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () => $SettingsTblFilterComposer($db: db, $table: table),
          createOrderingComposer: () => $SettingsTblOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () => $SettingsTblAnnotationComposer($db: db, $table: table),
...
typedef $SettingsTblProcessedTableManager =
...
class $LogTblFilterComposer extends Composer<_$Database, LogTbl> {
  ...
  ColumnFilters<String> get stack =>
      $composableBuilder(column: $table.stack, builder: (column) => ColumnFilters(column));
}
...
class $LogTblOrderingComposer extends Composer<_$Database, LogTbl> {
  ...
  ColumnOrderings<String> get stack =>
      $composableBuilder(column: $table.stack, builder: (column) => ColumnOrderings(column));
}
...
class $LogTblAnnotationComposer extends Composer<_$Database, LogTbl> {
  ...
  GeneratedColumn<String> get stack => $composableBuilder(column: $table.stack, builder: (column) => column);
}

class $LogTblTableManager
    extends
        RootTableManager<
          _$Database,
          LogTbl,
  ...
  $LogTblTableManager(_$Database db, LogTbl table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () => $LogTblFilterComposer($db: db, $table: table),
          createOrderingComposer: () => $LogTblOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () => $LogTblAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
              ...
              }) => LogTblCompanion(id: id, time: time, level: level, message: message, stack: stack),
          createCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<int> time = const Value.absent(),
                ...
                required String message,
                Value<String?> stack = const Value.absent(),
              }) => LogTblCompanion.insert(id: id, time: time, level: level, message: message, stack: stack),
          withReferenceMapper: (p0) => p0.map((e) => (e.readTable(table), BaseReferences(db, table, e))).toList(),
          prefetchHooksCallback: null,
        ),
      );
...
typedef $LogTblProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      LogTbl,
      LogTblData,
...
class $LogPrefixTblFilterComposer extends Composer<_$Database, LogPrefixTbl> {
  ...
  ColumnFilters<String> get prefix =>
      $composableBuilder(column: $table.prefix, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get logId => $composableBuilder(column: $table.logId, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get word => $composableBuilder(column: $table.word, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get len => $composableBuilder(column: $table.len, builder: (column) => ColumnFilters(column));
}
...
class $LogPrefixTblOrderingComposer extends Composer<_$Database, LogPrefixTbl> {
  ...
  ColumnOrderings<String> get prefix =>
      $composableBuilder(column: $table.prefix, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get logId =>
      $composableBuilder(column: $table.logId, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get word =>
      $composableBuilder(column: $table.word, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get len => $composableBuilder(column: $table.len, builder: (column) => ColumnOrderings(column));
}

class $LogPrefixTblAnnotationComposer extends Composer<_$Database, LogPrefixTbl> {
  ...
  GeneratedColumn<String> get prefix => $composableBuilder(column: $table.prefix, builder: (column) => column);

  GeneratedColumn<int> get logId => $composableBuilder(column: $table.logId, builder: (column) => column);

  GeneratedColumn<String> get word => $composableBuilder(column: $table.word, builder: (column) => column);

  GeneratedColumn<int> get len => $composableBuilder(column: $table.len, builder: (column) => column);
}

class $LogPrefixTblTableManager
    extends
        RootTableManager<
          _$Database,
          LogPrefixTbl,
          ...
          (LogPrefixTblData, BaseReferences<_$Database, LogPrefixTbl, LogPrefixTblData>),
          LogPrefixTblData,
          PrefetchHooks Function()
        > {
  $LogPrefixTblTableManager(_$Database db, LogPrefixTbl table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () => $LogPrefixTblFilterComposer($db: db, $table: table),
          createOrderingComposer: () => $LogPrefixTblOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () => $LogPrefixTblAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                ...
                Value<int> rowid = const Value.absent(),
              }) => LogPrefixTblCompanion(prefix: prefix, logId: logId, word: word, len: len, rowid: rowid),
          createCompanionCallback:
              ({
                required String prefix,
                required int logId,
                ...
                required int len,
                Value<int> rowid = const Value.absent(),
              }) => LogPrefixTblCompanion.insert(prefix: prefix, logId: logId, word: word, len: len, rowid: rowid),
          withReferenceMapper: (p0) => p0.map((e) => (e.readTable(table), BaseReferences(db, table, e))).toList(),
          prefetchHooksCallback: null,
        ),
      );
...
typedef $LogPrefixTblProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      LogPrefixTbl,
      LogPrefixTblData,
      ...
      PrefetchHooks Function()
    >;
typedef $CharacteristicTblCreateCompanionBuilder =
    CharacteristicTblCompanion Function({
      required String type,
      required int id,
      required String data,
      Value<int> metaCreatedAt,
...
typedef $CharacteristicTblUpdateCompanionBuilder =
    CharacteristicTblCompanion Function({
      Value<String> type,
      Value<int> id,
      Value<String> data,
...
class $CharacteristicTblFilterComposer extends Composer<_$Database, CharacteristicTbl> {
...
class $CharacteristicTblOrderingComposer extends Composer<_$Database, CharacteristicTbl> {
...
class $CharacteristicTblAnnotationComposer extends Composer<_$Database, CharacteristicTbl> {
...
class $CharacteristicTblTableManager
    extends
        RootTableManager<
          _$Database,
          CharacteristicTbl,
          ...
          (CharacteristicTblData, BaseReferences<_$Database, CharacteristicTbl, CharacteristicTblData>),
          CharacteristicTblData,
          PrefetchHooks Function()
        > {
  $CharacteristicTblTableManager(_$Database db, CharacteristicTbl table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () => $CharacteristicTblFilterComposer($db: db, $table: table),
          createOrderingComposer: () => $CharacteristicTblOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () => $CharacteristicTblAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
...
typedef $CharacteristicTblProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      CharacteristicTbl,
      CharacteristicTblData,
...
class $KvTblFilterComposer extends Composer<_$Database, KvTbl> {
  ...
  ColumnFilters<String> get k => $composableBuilder(column: $table.k, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get vstring =>
      $composableBuilder(column: $table.vstring, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get vint => $composableBuilder(column: $table.vint, builder: (column) => ColumnFilters(column));

  ColumnFilters<double> get vdouble =>
      $composableBuilder(column: $table.vdouble, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get vbool => $composableBuilder(column: $table.vbool, builder: (column) => ColumnFilters(column));
...
class $KvTblOrderingComposer extends Composer<_$Database, KvTbl> {
  ...
  ColumnOrderings<String> get k => $composableBuilder(column: $table.k, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get vstring =>
      $composableBuilder(column: $table.vstring, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get vint =>
      $composableBuilder(column: $table.vint, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<double> get vdouble =>
      $composableBuilder(column: $table.vdouble, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get vbool =>
      $composableBuilder(column: $table.vbool, builder: (column) => ColumnOrderings(column));
...
class $KvTblAnnotationComposer extends Composer<_$Database, KvTbl> {
  ...
  GeneratedColumn<String> get k => $composableBuilder(column: $table.k, builder: (column) => column);

  GeneratedColumn<String> get vstring => $composableBuilder(column: $table.vstring, builder: (column) => column);

  GeneratedColumn<int> get vint => $composableBuilder(column: $table.vint, builder: (column) => column);

  GeneratedColumn<double> get vdouble => $composableBuilder(column: $table.vdouble, builder: (column) => column);

  GeneratedColumn<int> get vbool => $composableBuilder(column: $table.vbool, builder: (column) => column);
  ...
  $KvTblTableManager(_$Database db, KvTbl table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () => $KvTblFilterComposer($db: db, $table: table),
          createOrderingComposer: () => $KvTblOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () => $KvTblAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
...
typedef $KvTblProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      KvTbl,
      KvTblData,
